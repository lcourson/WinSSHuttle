...
sys.stderr.write(' s: Staring ' + 'Assembler\n')
verbosity = verbosity  # noqa: F821 must be a previously defined global
z = zlib.decompressobj()
while 1:
    name = sys.stdin.readline().strip()
    if name:
        sys.stderr.write(' s: Found Name: %r\n' % name)
        ...
        sys.stderr.write(' s: Found Line: %r\n' % name)
        #break

sys.stderr.write(' s: Assembler ' + 'Complete\n')
sys.stderr.flush()
sys.stdout.flush()
